package com.example.pietromezza.memorygame;
...
// Import di varie classi utili per la realizzazione di questo progetto


public class MainActivity extends AppCompatActivity {

    TextView tv_p1, tv_p2; //dichiarazione/instanziazione variabili di tipo TextView

    ImageView iv_11, iv_12, iv_13, iv_14, iv_21, iv_22, iv_23, iv_24, iv_31, iv_32, iv_33, iv_34, iv_35, iv_36, iv_37, iv_38;//dichiarazione/instanziazione variabili di tipo  ImageView

    Integer[] cardArray = {101, 102, 103, 104, 105, 106, 201, 202, 203, 204, 205, 206}; //Array di Interi
    ...
    int turn = 1;
    int playerPoints = 0, couPoints = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Carico le immagine delle carte
        frontOfCardsResources();

        //Mescola le immagini
        Collections.shuffle(Arrays.asList(cardArray));
        //Cmbia il colore dele secondo giocatore(inattivo)
    ...
    private void doStuff(ImageView iv, int card) {
        //setta le immagine corrette all'imageview
        ...
        //Controlla quale immagine è stata selezionata e la salva in una variabile temporanea
        if (cardNumber == 1) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    //Controlla se le immagini selezionate sono uguali
                    calculate();
                }
            }, 1000);
        }
    ...
    private void calculate() {
        //Se le immagini sono uguali le rimuove e aggiunge un punto
        if (firstCard == secondCard) {
            ...
            //Aggiugge punti al giocatore corretto
            if (turn == 1) {
                playerPoints++;
                tv_p1.setText("GIOCATORE1: " + playerPoints);
            } else if (turn == 2) {
                couPoints++;
                tv_p2.setText("GIOCATORE2: " + couPoints);
            }
        } else {
            ...
            iv_36.setImageResource(R.drawable.ic_back);
            iv_37.setImageResource(R.drawable.ic_back);
            iv_38.setImageResource(R.drawable.ic_back);
